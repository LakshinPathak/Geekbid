...
**Last updated:** 2026-07-20 (ISSUE-1, 2, 3, 35, 42 fixed — batch 1 committed/pushed to `v19`)
...
| ISSUE-4 | Direct Hire offers cannot be accepted/declined in UI | Not Started | | | |

## High

| Issue | Title | Status | Date | Commit/Files | Notes |
|---|---|---|---|---|---|
| ISSUE-5 | Bid monthly quota consumed on cooldown 429 | Not Started | | | |
| ISSUE-6 | Accept/award mints "held" escrow with no payment | Not Started | | | |
| ISSUE-7 | Team seat enforcement — wrong `_id` type | Not Started | | | |
...
| ISSUE-36 | Dual-role register re-applies referral | Not Started | | | |
| ISSUE-37 | Assessment submit race inflates GeekScore | Not Started | | | |
| ISSUE-38 | Google login always sends `role=` | Not Started | | | |
| ISSUE-39 | Team invitee cannot accept invite in UI | Not Started | | | |
| ISSUE-40 | Over-limit team: no remove-member UI/API | Not Started | | | |
| ISSUE-41 | Session restore race redirects to `/login` | Not Started | | | |
...
| ISSUE-46 | Team accept ignores seat cap/races | Not Started | | | |
...
*(ISSUE-1, ISSUE-3 = Critical; ISSUE-2, ISSUE-35, ISSUE-42 = High. 5 issues done total.)*
