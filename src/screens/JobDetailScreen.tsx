  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.priceCard}>
        ...
        <AnimatedPrice value={current} style={styles.detailPriceText} />
...
const styles = StyleSheet.create({
  ...
  avatarText: { ...typography.captionBold, color: colors.text, fontWeight: '700' },
  ...
  bidderAvatarText: { ...typography.label, color: colors.text, fontSize: 10, fontWeight: '700' },
