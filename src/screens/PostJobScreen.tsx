    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {step === 'pricing' && (
        <>
          ...
          <View style={styles.navRow}>
            <Button title="← Details" onPress={() => setStep('details')} variant="outline" style={{ flex: 1 }} />
            <Button title="Review →" onPress={() => setStep('review')} variant="secondary" style={{ flex: 1 }} />
          </View>
        </>
      )}
      ...
      {step === 'review' && (
        <>
          ...
          <View style={styles.navRow}>
            <Button title="← Pricing" onPress={() => setStep('pricing')} variant="outline" style={{ flex: 1 }} />
            <Button testID="postjob-submit-btn" title="⚡ Publish Job" onPress={() => void onSubmit()} loading={isSubmitting} style={{ flex: 1 }} />
          </View>
        </>
      )}
    </ScrollView>
