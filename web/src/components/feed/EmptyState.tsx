...
function JobsIllustration() {
  return (
    <svg width="88" height="72" viewBox="0 0 88 72" fill="none" aria-hidden="true">
      ...
      <line x1="18" y1="28" x2="52" y2="28" stroke="#46424e" strokeOpacity="0.4" strokeWidth="2" strokeLinecap="round" />
      <line x1="18" y1="38" x2="70" y2="38" stroke="#46424e" strokeOpacity="0.25" strokeWidth="2" strokeLinecap="round" />
      <line x1="18" y1="48" x2="60" y2="48" stroke="#46424e" strokeOpacity="0.25" strokeWidth="2" strokeLinecap="round" />
...
function BidsIllustration() {
  return (
    <svg width="88" height="72" viewBox="0 0 88 72" fill="none" aria-hidden="true">
      ...
      <circle cx="14" cy="52" r="3" fill="#46424e" fillOpacity="0.4" />
    </svg>
  );
}
...
function TalentIllustration() {
  return (
    <svg width="88" height="72" viewBox="0 0 88 72" fill="none" aria-hidden="true">
      <circle cx="30" cy="26" r="10" stroke="#46424e" strokeOpacity="0.35" strokeWidth="1.5" />
      <path d="M14 58c0-9 7-15 16-15s16 6 16 15" stroke="#46424e" strokeOpacity="0.35" strokeWidth="1.5" />
...
export default function EmptyState({ variant = "jobs", title, subtitle, ctaLabel, onCta }: EmptyStateProps) {
  ...
  return (
    <div className="text-center py-14 px-4 flex flex-col items-center gap-3">
      ...
      {subtitle && <p className="text-[#46424e] text-sm max-w-sm">{subtitle}</p>}
      {ctaLabel && onCta && (
