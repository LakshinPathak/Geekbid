...
export default function MarketIntel({
 ...
 <span className="text-[10px] text-[#6b5f45] ml-auto">{categoryLabels}</span>
 </div>

 <div className="flex flex-wrap items-center gap-4 text-sm">
 {/* Avg starting price */}
 <div className="flex items-center gap-2">
 <span className="text-[#6b5f45]">Avg Starting:</span>
 ...
 <div className="flex items-center gap-2">
 <span className="text-[#6b5f45]">Avg Decay:</span>
 ...
 <div className="w-px h-4 bg-[rgba(201,168,76,0.15)]" />
 <div className="flex items-center gap-2">
 <Clock className="h-3.5 w-3.5 text-[#6b5f45]" />
 <span className="text-[#6b5f45]">1st Bid ~</span>
 ...
 <div className="w-px h-4 bg-[rgba(201,168,76,0.15)]" />
 <div className="flex items-center gap-2">
 <Tag className="h-3.5 w-3.5 text-[#6b5f45]" />
 <span className="text-[#6b5f45]">Hot:</span>
