...
/* ─── Tracks prefers-reduced-motion. Landing sections with a running
   interval/timeout loop (price tickers, kinetic drops) freeze to a
   static representative frame instead of animating when this is true. */
